...
void Object::draw()
{
    ...
    // Pošleme z CPU do GPU uniformní proměnné aktualizovaných dat
    ...
    // viewMatrix a projectionMatrix a viewPos se updatuje ve ShaderProgram classe při změně kamery
